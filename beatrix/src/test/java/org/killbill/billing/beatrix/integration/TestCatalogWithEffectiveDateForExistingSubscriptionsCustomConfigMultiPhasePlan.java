...
public class TestCatalogWithEffectiveDateForExistingSubscriptionsCustomConfigMultiPhasePlan extends TestIntegrationBase {
    ...
    public void testMultiPhasePlanWithTrialPhase() throws Exception {
        ...
        final UUID entitlementId = entitlementApi.createBaseEntitlement(account.getId(), new DefaultEntitlementSpecifier(new PlanPhaseSpecifier("liability-monthly-trial"), null, UUID.randomUUID().toString(), null), "something", null, null, false, true, ImmutableList.<PluginProperty>of(), callContext);
    ...
    public void testMultiPhasePlanWithDiscountPhaseSubAlignedWithChange() throws Exception { //This test is exactly the same as the scenario reported in https://github.com/killbill/killbill/issues/1862
        ...
        final Account account = createAccountWithNonOsgiPaymentMethod(getAccountData(18));
        busHandler.pushExpectedEvents(NextEvent.CREATE, NextEvent.BLOCK, NextEvent.INVOICE);
        final UUID entitlementId = entitlementApi.createBaseEntitlement(account.getId(), new DefaultEntitlementSpecifier(new PlanPhaseSpecifier("liability-monthly-discount"), null, UUID.randomUUID().toString(), null), "something", null, null, false, true, ImmutableList.<PluginProperty>of(), callContext);
        final Entitlement bpEntitlement1 = entitlementApi.getEntitlementForId(entitlementId, callContext);
        assertListenerStatus();
        assertNotNull(bpEntitlement1);
    ...
    public void testMultiPhasePlanPriceChangeInDiscountPhaseSubAlignedWithChange() throws Exception {
        ...
        final UUID entitlementId = entitlementApi.createBaseEntitlement(account.getId(), new DefaultEntitlementSpecifier(new PlanPhaseSpecifier("liability-monthly-discount3"), null, UUID.randomUUID().toString(), null), "something", null, null, false, true, ImmutableList.<PluginProperty>of(), callContext);
        final Entitlement bpEntitlement1 = entitlementApi.getEntitlementForId(entitlementId, callContext);
        assertListenerStatus();
        assertNotNull(bpEntitlement1);
    ...
    public void testMultiPhasePlanWithoutEffectiveDateForExistingSubs() throws Exception {
        ...
        busHandler.pushExpectedEvents(NextEvent.CREATE, NextEvent.BLOCK, NextEvent.INVOICE);
        final UUID entitlementId = entitlementApi.createBaseEntitlement(account.getId(), new DefaultEntitlementSpecifier(new PlanPhaseSpecifier("liability-monthly-discount2"), null, UUID.randomUUID().toString(), null), "something", null, null, false, true, ImmutableList.<PluginProperty>of(), callContext);
        final Entitlement bpEntitlement1 = entitlementApi.getEntitlementForId(entitlementId, callContext);
        assertListenerStatus();
        assertNotNull(bpEntitlement1);
    ...
    public void testMultiPhasePlanChangePlanFromTrialToDiscount() throws Exception {
        ...
        bpEntitlement1.changePlanOverrideBillingPolicy(new DefaultEntitlementSpecifier(new PlanPhaseSpecifier("liability-monthly-discount"), null, UUID.randomUUID().toString(), null), null, BillingActionPolicy.END_OF_TERM, ImmutableList.<PluginProperty>of(), callContext);
