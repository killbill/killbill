...
public abstract class BeatrixTestSuiteWithEmbeddedDB extends GuicyKillbillTestSuiteWithEmbeddedDB {
    ...
    protected static final Map<String, String> DEFAULT_BEATRIX_PROPERTIES = Map.of("org.killbill.catalog.uri", "catalogs/default/catalogTest.xml",
                                                                                   ...
                                                                                   "org.killbill.invoice.globalLock.retries", "300");
