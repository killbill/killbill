...
public class TestOverdueWithSubscriptionCancellation extends TestOverdueBase {
    ...
    public void testCheckSubscriptionCancellation() throws Exception {
        ...
        final SubscriptionBase cancelledBaseSubscription = ((DefaultEntitlement) entitlementApi.getEntitlementForId(baseEntitlement.getId(), false, callContext)).getSubscriptionBase(); //TODO_1030: Backward compatibility
        assertTrue(cancelledBaseSubscription.getState() == EntitlementState.CANCELLED);

        final SubscriptionBase cancelledAddon1= ((DefaultEntitlement) entitlementApi.getEntitlementForId(addOn1.getId(), false, callContext)).getSubscriptionBase(); //TODO_1030: Backward compatibility
    ...
    public void testCheckSubscriptionCancellationWithMultipleBundles() throws Exception {
        ...
        final SubscriptionBase cancelledBaseSubscription2 = ((DefaultEntitlement) entitlementApi.getEntitlementForId(baseEntitlement2.getId(), false, callContext)).getSubscriptionBase(); //TODO_1030: Backward compatibility
        ...
        final SubscriptionBase cancelledBaseEntitlement3 = ((DefaultEntitlement) entitlementApi.getEntitlementForId(baseEntitlement3.getId(), false, callContext)).getSubscriptionBase(); //TODO_1030: Backward compatibility
