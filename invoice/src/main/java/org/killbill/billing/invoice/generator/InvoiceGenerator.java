...
public interface InvoiceGenerator {
    InvoiceWithMetadata generateInvoice(ImmutableAccountData account, @Nullable BillingEventSet events, AccountInvoices existingInvoices,
                                        final UUID targetInvoiceId, LocalDate targetDate, Currency targetCurrency, final DryRunType dryRunType, InternalCallContext context) throws InvoiceApiException;
}
