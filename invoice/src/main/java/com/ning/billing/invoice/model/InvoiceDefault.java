...
public class InvoiceDefault implements Invoice {
    ...
    public InvoiceDefault(UUID accountId, DateTime targetDate, Currency currency) {
        this(UUID.randomUUID(), accountId, new Clock().getUTCNow(), targetDate, currency, null, BigDecimal.ZERO, new ArrayList<IInvoiceItem>());
    }

    public InvoiceDefault(UUID invoiceId, UUID accountId, DateTime invoiceDate, DateTime targetDate,
