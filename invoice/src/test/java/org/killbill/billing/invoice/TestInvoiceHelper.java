...
public class TestInvoiceHelper {
    ...
    public SubscriptionBase createSubscription() throws SubscriptionBaseApiException {
        ...
        Mockito.when(subscriptionApi.getSubscriptionFromId(Mockito.<UUID>any(), false, Mockito.<InternalTenantContext>any())).thenReturn(subscription); //TODO_1030: Backward compatibility
        return subscription;
    }
