...
import com.ning.billing.subscription.engine.core.EntitlementNotificationKey;
        ...
        transactionalSqlDao.execute(new EntitySqlDaoTransactionWrapper<Void>() {
            ...
            public Void inTransaction(final EntitySqlDaoWrapperFactory<EntitySqlDao> entitySqlDaoWrapperFactory) throws Exception {
                ...
                try {
                    ...
                    final RepairEntitlementInternalEvent busEvent = new DefaultRepairSubscriptionEvent(accountId, bundleId, clock.getUTCNow(),
