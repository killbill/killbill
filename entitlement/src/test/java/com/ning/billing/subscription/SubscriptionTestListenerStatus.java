...
public class SubscriptionTestListenerStatus implements TestListenerStatus {

    private final Logger log = LoggerFactory.getLogger(SubscriptionTestListenerStatus.class);
    ...
    @Inject
    public SubscriptionTestListenerStatus() {
