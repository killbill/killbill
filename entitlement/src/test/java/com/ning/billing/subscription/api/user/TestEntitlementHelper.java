...
public class TestEntitlementHelper {
    ...
    @Inject
    public TestEntitlementHelper(final SubscriptionUserApi entitlementApi, final Clock clock, final InternalCallContext callContext, final TestApiListener testListener, final SubscriptionDao dao) {
