...
public class TestDefaultSubscriptionApi extends EntitlementTestSuiteWithEmbeddedDB {
    ...
    public void testWithMultipleBundle() throws AccountApiException, SubscriptionApiException, EntitlementApiException {
        ...
        entitlementApi.transferEntitlements(account.getId(), account2.getId(), externalKey, new LocalDate(clock.getUTCNow(), account.getTimeZone()), Collections.emptyMap(), BcdTransfer.USE_EXISTING, Collections.emptyList(), callContext);
        assertListenerStatus();
