...
public class TestCache extends UtilTestSuiteWithEmbeddedDB {
    ...
    public void testCacheRecordId() throws Exception {
        this.transactionalSqlDao = new EntitySqlDaoTransactionalJdbiWrapper(dbi, databaseTransactionNotificationApi, clock, controlCacheDispatcher, nonEntityDao, internalCallContextFactory);
