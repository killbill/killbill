...
public class TestDefaultPagination extends UtilTestSuiteNoDB {
    ...
    public void testDefaultPaginationBuilder() throws Exception {
        ...
        Assert.assertEquals(DefaultPagination.<Integer>build(0L, 3L, List.of(1, 2, 3, 4, 5)), expectedOf(0L, 3L, 5L, List.of(1, 2, 3)));
        Assert.assertEquals(DefaultPagination.<Integer>build(1L, 3L, List.of(1, 2, 3, 4, 5)), expectedOf(1L, 3L, 5L, List.of(2, 3, 4)));
