...
public class TestJDBCSessionDaoUnit extends UtilTestSuiteNoDB {
    ...
    @Test(groups = "fast")
    public void testNoUpdateSessionsCache() {
        final JDBCSessionDao jdbcSessionDao = createJdbcSessionDao();

        jdbcSessionDao.noUpdateSessionsCache.put("A", Boolean.TRUE);
        jdbcSessionDao.noUpdateSessionsCache.put("B", Boolean.TRUE);
        jdbcSessionDao.noUpdateSessionsCache.put("C", Boolean.TRUE);
        jdbcSessionDao.noUpdateSessionsCache.put("D", Boolean.TRUE);
        jdbcSessionDao.noUpdateSessionsCache.put("E", Boolean.TRUE);
        jdbcSessionDao.noUpdateSessionsCache.put("F", Boolean.TRUE);

        Assert.assertNull(jdbcSessionDao.noUpdateSessionsCache.get("A"));
        Assert.assertNotNull(jdbcSessionDao.noUpdateSessionsCache.get("B"));
    }
}
