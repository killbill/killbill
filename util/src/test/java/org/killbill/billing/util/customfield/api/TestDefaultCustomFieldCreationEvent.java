...
public class TestDefaultCustomFieldCreationEvent {
    ...
    public void testEquality() {
        ...
        final DefaultCustomFieldCreationEvent evt1 = new DefaultCustomFieldCreationEvent(customFID, oid, objType, 1L, 2L, userToken);
        ...
        final DefaultCustomFieldCreationEvent evt2 = new DefaultCustomFieldCreationEvent(UUID.randomUUID(), oid, objType, 1L, 2L, userToken);

        Assert.assertNotEquals(evt1, evt2);
        Assert.assertNotEquals(evt2, evt1);

        // Same as evt1.
        final DefaultCustomFieldCreationEvent evt3 = new DefaultCustomFieldCreationEvent(customFID, oid, objType, 1L, 2L, userToken);
        Assert.assertEquals(evt1, evt3);
        Assert.assertEquals(evt3, evt1);

        // Same as evt1, different eventBase attributes
        final DefaultCustomFieldCreationEvent evt4 = new DefaultCustomFieldCreationEvent(customFID, oid, objType, 100L, 200L, UUID.randomUUID());
