...
public class RedissonLockerClientProvider implements Provider<RedissonClient> {

    private final RedisLockerConfig cacheConfig;

    @Inject
    public RedissonLockerClientProvider(final RedisLockerConfig cacheConfig) {
