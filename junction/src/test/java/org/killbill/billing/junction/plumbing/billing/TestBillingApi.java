...
public class TestBillingApi extends JunctionTestSuiteNoDB {
    ...
    public void beforeMethod() throws Exception {
        ...
        Mockito.when(subscriptionInternalApi.getSubscriptionFromId(Mockito.<UUID>any(), false, Mockito.<InternalTenantContext>any())).thenReturn(subscription); //TODO_1030: Backward compatibility
