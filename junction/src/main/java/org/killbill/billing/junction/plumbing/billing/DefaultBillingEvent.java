...
public class DefaultBillingEvent implements BillingEvent {
    ...
    public DefaultBillingEvent(final SubscriptionBillingEvent inputEvent,
        ...
        this.isCancelledOrBlocked = inputEvent.getType() == SubscriptionBaseTransitionType.CANCEL || inputEvent.getType() == SubscriptionBaseTransitionType.EXPIRED; //TODO_15233 added this to prevent tests from TestCatalogFixedTerm from failing. Revisit later
