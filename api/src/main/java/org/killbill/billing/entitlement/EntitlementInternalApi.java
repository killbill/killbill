...
public interface EntitlementInternalApi {
    ...
    Entitlement getEntitlementForId(final UUID uuid, final boolean includeDeletedSubscriptionEvents, final InternalTenantContext tenantContext) throws EntitlementApiException;
