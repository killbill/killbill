...
public class TestPatternObfuscator extends ServerTestSuiteNoDB {
    ...
    public void testXmlWithAttributesOnTheKey() throws Exception {
        verify("<PayerInfo xsi:type=\"ebl:PayerInfoType\">\n" +
               "<accountnumber xsi:type=\"ebl:EmailAddressType\">dragongem@gmail.com</accountnumber>\n" +
               "<PayerID xsi:type=\"ebl:UserIDType\">RHS3GS7PN7MLA</PayerID>\n" +
               ...
               "<ccFirstName xmlns=\"urn:ebay:apis:eBLBaseComponents\">Rochelle</ccFirstName>\n" +
               "<MiddleName xmlns=\"urn:ebay:apis:eBLBaseComponents\"></MiddleName>\n" +
               "<ccLastName xmlns=\"urn:ebay:apis:eBLBaseComponents\">Herrick</ccLastName>",
