...
public class TestObfuscatorConverter extends ServerTestSuiteNoDB {
    ...
    @Test(groups = "fast")
    public void testLogSensitiveDataWithExtendedObsfucator() throws Exception {
        verifyWithExtendedObfuscator("Starting purchase call: \n" +
                                     "<gateway>\n" +
                                     "<card>4111111111111111</card>\n" +
                                     "<bankAccountNumber>482391823</bankAccountNumber>\n" +
                                     "<password>supersecret</password>\n" +
    ...
    private void verifyWithExtendedObfuscator(final String input, final String output) {
    ...
    class ExtendedObfuscatorConverter extends ObfuscatorConverter {
        ...
        public List<String> getOptionList() {
            return ImmutableList.of("org.killbill.billing.server.log.obfuscators.PatternObfuscator");
        }
    }
}
