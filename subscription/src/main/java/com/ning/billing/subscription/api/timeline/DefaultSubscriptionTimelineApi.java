...
public class DefaultSubscriptionTimelineApi extends SubscriptionApiBase implements SubscriptionTimelineApi {
    ...
    @Inject
    public DefaultSubscriptionTimelineApi(final CatalogService catalogService,
                                          ...
                                          @Named(DefaultSubscriptionModule.REPAIR_NAMED) final SubscriptionApiService repairApiService,
    ...
    private SubscriptionDataRepair createSubscriptionDataRepair(final SubscriptionData curData, final DateTime newBundleStartDate, final DateTime newSubscriptionStartDate, final List<SubscriptionEvent> initialEvents) {
